...
function advanceComponents(list) {
  ...
  return list.map(function (_ref) {
    ...
    var C = function C(props) {
      if (_.get(props.extraProps, 'component') !== name) return props.next(props);
      return __jsx(Components, Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_2__["default"])({}, props, {
        __self: _this2,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 32,
...
//# sourceMappingURL=calculated-field.js.cb18b7358c3574739b31.hot-update.js.map