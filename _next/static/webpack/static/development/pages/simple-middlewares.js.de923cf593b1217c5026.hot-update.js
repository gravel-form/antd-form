...
/* harmony import */ var _layouts_main__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../layouts/main */ "./layouts/main.tsx");
/* harmony import */ var _components_DemoForm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/DemoForm */ "./components/DemoForm.tsx");
...
var MyButtonsMw = function MyButtonsMw(props) {
  ...
  var handleSubmit = function handleSubmit() {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.async(function handleSubmit$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            setSubmitting(true);
            _context.next = 3;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.awrap(__webpack_require__(/*! bluebird */ "./node_modules/bluebird/js/browser/bluebird.js").delay(1000));

          case 3:
            // pactically, should check unmounted here
            setSubmitting(false);

            antd_lib_message__WEBPACK_IMPORTED_MODULE_5___default.a.success('Submitted!');
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_7__["Fragment"], null, next(props)
  ...
  }, "Submit"), ' ', __jsx(antd_lib_button__WEBPACK_IMPORTED_MODULE_2___default.a, {
    onClick: handleClear,
    __self: _this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, "Clear"), " ", __jsx(antd_lib_button__WEBPACK_IMPORTED_MODULE_2___default.a, {
    onClick: handleReset,
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
var MyFormItemTemplate = function MyFormItemTemplate(props) {
  ...
  var id = toJSONSchemaPath(dataPath);
  var error = errors && errors.find(function (_ref) {
    var dataPath = _ref.dataPath;
    return dataPath === id;
  });
  return __jsx(Form.Item, Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
...
var IndexPage = function IndexPage() {
  ...
  }, __jsx(_components_DemoForm__WEBPACK_IMPORTED_MODULE_9__["default"], {
    code: code,
    scope: {
      schema: schema,
      extraProps: extraProps,
...
//# sourceMappingURL=simple-middlewares.js.de923cf593b1217c5026.hot-update.js.map