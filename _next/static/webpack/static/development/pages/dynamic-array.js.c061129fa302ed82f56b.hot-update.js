...
var SubmitButtonMw = function SubmitButtonMw(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_9__["Fragment"], null, props.next(props), __jsx(antd_lib_form__WEBPACK_IMPORTED_MODULE_5___default.a.Item, {
    ...
    onClick: onSubmit,
    type: "primary"
  }, lodash_get__WEBPACK_IMPORTED_MODULE_10___default()(extraProps, 'props'), {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19,
...
var SubmitButtonWithValidationMw = function SubmitButtonWithValidationMw(props) {
  ...
  var handleClick = function handleClick() {
    try {
      ...
      if (!_errors) onSubmit && onSubmit(data);
      console.log(_errors);
      setErrors(_errors);
...
//# sourceMappingURL=dynamic-array.js.c061129fa302ed82f56b.hot-update.js.map