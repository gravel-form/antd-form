...
// const prefixedLink = (url: string) => `${linkPrefix}${url}`;
...
var Page = function Page(_ref) {
  ...
  return __jsx(antd_lib_layout__WEBPACK_IMPORTED_MODULE_3___default.a, {
    ...
    onClick: function onClick(_ref2) {
      var key = _ref2.key;
      next_router__WEBPACK_IMPORTED_MODULE_5___default.a.push(key, "/".concat(process.env.BACKEND_URL).concat(key));
    },
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=kitchensink.js.006ea84770d144d8c3b6.hot-update.js.map